...
from .models.speaker_model import get_speaker_model
from .utils.checkpoint import load_checkpoint
from .diar.umap_clusterer import cluster
from .diar.extract_emb import subsegment
from .diar.make_rttm import merge_segments
...
def load_model_local(model_dir: str= 'models/Recognition/wespeaker/voxceleb_resnet221_LM') -> Speaker:

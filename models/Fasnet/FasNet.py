...
first_model_weight_file = WEIGHTS_DIR / "2.7_80x80_MiniFASNetV2.pth"
second_model_weight_file = WEIGHTS_DIR / "4_0_0_80x80_MiniFASNetV1SE.pth"
class Fasnet:
...
if __name__ == "__main__":
    ...
    img = cv2.imread(os.path.join(assets_path, "img1.jpg"))
    model = Fasnet()
